object Versions {
    ...
    const val testing = "7.1.0"
    const val jupiter = "5.8.1"
    const val core_testing = "2.1.0"
    const val slf4j = "1.7.32"
    const val espressoCore = "3.5.1"
    const val composeUiTestJunit4 = "1.5.1"
    const val composeUiTestManifest = "1.5.1"
}
...
object Deps {
    ...
    const val testing = "org.testng:testng:${Versions.testing}"
    const val jupiterEngine = "org.junit.jupiter:junit-jupiter-engine:${Versions.jupiter}"
    const val jupiterApi = "org.junit.jupiter:junit-jupiter-api:${Versions.jupiter}"
    const val coreTesting = "androidx.arch.core:core-testing:${Versions.core_testing}"
    const val slf4j = "org.slf4j:slf4j-simple:${Versions.slf4j}"
    const val kotlinTest = "org.jetbrains.kotlin:kotlin-test:1.8.21"
    const val composeUiTestJunit4 = "androidx.compose.ui:ui-test-junit4:${Versions.composeUiTestJunit4}"
    const val composeUiTestManifest = "androidx.compose.ui:ui-test-manifest:${Versions.composeUiTestManifest}"
    const val espressoCore = "androidx.test.espresso:espresso-core:${Versions.espressoCore}"
    const val koinTest = "io.insert-koin:koin-test:${Versions.koin}"
    const val koinJunitTest = "io.insert-koin:koin-test-junit4:${Versions.koin}"
}